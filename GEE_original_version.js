...
// London Heat & Green Space Dashboard
// ============================================================================
...
print('HRI borough layer:', hriBoroughs.first());
...
/************************************
 PART 1: LSOA POPULATION DENSITY LQ
************************************/
...
// 1.3 Calculate LSOA population density
...
/************************************
 PART 1B: BOROUGH POPULATION DENSITY LQ
************************************/
...
// ============================================================================
// Section 1B: Language Management
...
// 2.2 Landsat 8/9 Collection 2 Level 2
...
// 2.3 Cloud mask and LST conversion
...
// 2.5 Borough-level LST statistics
...
// 2.7 UHI binary image
var uhiMap = lstMean2022
  .gte(uhiThreshold)
  .rename('UHI');


// 2.8 Borough-level UHI proportion
...
// 3.2 Extract green cover classes
// 10 = Tree cover
// 20 = Shrubland
// 30 = Grassland
// 40 = Cropland
...
// 3.3 Borough-level green cover statistics
...
print('HRI table sample:');


// ==============================
// 4B.2 JOIN HRI TABLE TO BOROUGH BOUNDARY
// ==============================
...
// 5.1 Selected borough placeholder
/************************************
 PART 5: PREPARE BOROUGH DASHBOARD DATA
************************************/
...
// ==============================
// 5.2 JOIN ALL BOROUGH INDICATORS
// ==============================
...
// ==============================
// 5.3 CREATE FINAL DASHBOARD DATA
// ==============================
...
var meanNDVILayer = ui.Map.Layer(
  ndviMean2022,
  {
    min: 0,
    max: 0.8,
...
/************************************
 PART 6C: SPLIT COMPARISON VIEW
 Whole London layer comparison only
************************************/
...
/************************************
 PART 7: UI PANEL + INTERACTION
************************************/

// ==============================
// 7.1 STYLE + HELPER FUNCTIONS
// ==============================
...
// ============================================================================
// Section 6B: HRI Legend
// ============================================================================

var legendPanel = null;

function createHRILegendRow(color, label) {
  return ui.Panel({
    widgets: [
      ui.Label('', {
...
function updateLegend() {
  ...
  legendPanel = ui.Panel({
    widgets: [
      ui.Label(translate('Heat Risk Index Scale'), {
        fontSize: '12px',
        fontWeight: 'bold',
        color: '#111827',
        margin: '0 0 4px 0',
...
createHRILegendRow('#fef0d9', translate('Very Low HRI 3.0–5.4')),
createHRILegendRow('#fdd49e', translate('Low HRI 5.4–7.8')),
createHRILegendRow('#fc8d59', translate('Medium HRI 7.8–10.2')),
createHRILegendRow('#d7301f', translate('High HRI 10.2–12.6')),
createHRILegendRow('#7f0000', translate('Very High HRI 12.6–15.0')),
...
// ==============================
// 7.6 LOAD DASHBOARD TABLE TO CLIENT
// ==============================
